...
def get_cls_dataset(cfg):
    ...
    if cfg.dataset.name == "luad":
        ...
        val_dataset = LUADTestDataset(cfg.dataset.val_root, split="test", transform=transform["val"])
    elif cfg.dataset.name == "bcss":
        train_dataset = BCSSTrainingDataset(cfg.dataset.train_root, transform=transform["train"])
        val_dataset = BCSSTestDataset(cfg.dataset.val_root, split="test", transform=transform["val"])
